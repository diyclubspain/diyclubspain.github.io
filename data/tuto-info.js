...
tutorialesApp.controller('TutorialesController', ['$scope', '$http', function ($scope, $http) {
...
//  $scope.tut_categoria = "";
//
//  $http.get('data/tutoriales.json').then(function(response){
...
//  });
  ...
  $scope.tutoriales = [
...

    {
      ...
      "pasos": [
        'Corta los imperdibles de la parte trasera de la chapa con los alicates',
        'Retira los trozos de aguja sobrantes',
        'Calienta la pistola de silicona y pon un poco en la parte de atrás de la chapa',
        'Coloca el imán con cuidado en el centro de la silicona y presiona',
        'Voilá! Ya tienes tus imanes molones'
      ]
    },

    {
      "imagen": "VACIAR-BOMBILLAS-RECICLAJE-ACORAMA",
      "categoria": "segunda",
      "titulo": "Cómo vaciar bombillas para tus proyectos",
      "master": "Acorama",
      "duracion": "10 min",
      "dificultad": "Fácil",
      "video": "https://www.youtube.com/embed/SAZiiLF_nFQ",
      "coste": "--",

      "descripcion": "Te enseñamos a vaciar una bombilla sin cortarte y sin que se rompa. Después podrás utilizarla en tus proyectos para darle todos los usos decorativos que se te ocurran",

      "materiales": [
        'Bombilla',
        'Guantes de protección',
        'Alicates o tenacillas',
        'Destornillador'
      ],

      "pasos": [
        'Sujeta con firmeza la bombilla en una mano sin apretar demasiado y con la ayuda de unos alicates o tenacillas extrae el botón metálico en la punta',
        'Apoya la rosca y golpea ligeramente el cristal negro con un martillo para quebrarlo',
        'Extrae el cristal con la ayuda de unas tenacillas',
        'Con un destornillador y un martillo golpea la parte de cristal que sostiene los filamentos',
        'Desprende los restos de esta pieza del interior de la rosca con un destornillador y unas tenacillas',
        'Ya tienes lista la bombilla para utilizarla en tus proyectos decorativos'
      ]
    },
