...
tutorialesApp.controller('TutorialesController', ['$scope', function ($scope) {
  ...
  $scope.openModal = function (event) {
    ...
    var $comentariosToModal = $(event.currentTarget).children('.modal-comentarios').text();
    ...
    $('.tut-comentarios').text($comentariosToModal);
  ...
  $scope.tutoriales = [

    {
      ...
      "pasos": ['Incididunt cillum vidisse laboris, eu amet expetendis commodo, ut dolore praetermissum ita qui lorem domesticarum o illum excepteur comprehenderit, qui sint iudicem familiaritatem, dolor reprehenderit iudicem duis admodum non incididunt duis quae do quid. Quo offendit nam nescius an an culpa id amet, lorem laborum eu eiusmod, cillum proident ex distinguantur.', 'Incididunt cillum vidisse laboris, eu amet expetendis commodo, ut dolore praetermissum ita qui lorem domesticarum o illum excepteur comprehenderit, qui sint iudicem familiaritatem, dolor reprehenderit iudicem duis admodum non incididunt duis quae do quid. Quo offendit nam nescius an an culpa id amet, lorem laborum eu eiusmod, cillum proident ex distinguantur.', 'Incididunt cillum vidisse laboris, eu amet expetendis commodo, ut dolore praetermissum ita qui lorem domesticarum o illum excepteur comprehenderit, qui sint iudicem familiaritatem, dolor reprehenderit iudicem duis admodum non incididunt duis quae do quid. Quo offendit nam nescius an an culpa id amet, lorem laborum eu eiusmod, cillum proident ex distinguantur.'],
    },
